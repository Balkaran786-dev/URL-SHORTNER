...
const UserUrl = () => {
  ...
  // Create a stable copy of the URLs array and sort by newest first
  // MongoDB ObjectIDs contain a timestamp in their first 4 bytes
  const stableUrls = [...urls.urls].sort((a, b) => {
    // Extract the timestamp part from MongoDB ObjectID
    // This is more reliable than substring(0,8)
